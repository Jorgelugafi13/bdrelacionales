...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 18-02-2025 a las 02:27:56
...
--
-- Estructura de tabla para la tabla `playlistcancione`
--

CREATE TABLE `playlistcancione` (
  `id` int(11) NOT NULL,
  `playlist_id` int(11) NOT NULL,
  `canciones_id` int(11) NOT NULL,
  `usuaio_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Indices de la tabla `playlistcancione`
--
ALTER TABLE `playlistcancione`
  ADD PRIMARY KEY (`id`),
  ADD KEY `playlist_id` (`playlist_id`),
  ADD KEY `canciones_id` (`canciones_id`),
  ADD KEY `usuaio_id` (`usuaio_id`);
...
--
-- AUTO_INCREMENT de la tabla `playlistcancione`
--
ALTER TABLE `playlistcancione`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Filtros para la tabla `playlistcancione`
--
ALTER TABLE `playlistcancione`
  ADD CONSTRAINT `playlistcancione_ibfk_1` FOREIGN KEY (`playlist_id`) REFERENCES `playlist` (`id`),
  ADD CONSTRAINT `playlistcancione_ibfk_2` FOREIGN KEY (`usuaio_id`) REFERENCES `usuarios` (`id`),
  ADD CONSTRAINT `playlistcancione_ibfk_3` FOREIGN KEY (`canciones_id`) REFERENCES `canciones` (`id`);
